...
using VersaScreenCapture.WindowsRuntimeHelpers;
...
namespace VersaScreenCapture
{
    ...
    public static class CaptureHandler
    {
        ...
        public static bool IsAvailable()
        {
            ...
            {
                //throw new Exception("Using Windows.Graphics.Capture not possible in current system!");
                return false;
            }
            else if (!GraphicsCaptureSession.IsSupported())
            {
                //throw new Exception("GraphicsCaptureSession not supported in current system!");
                return false;
            }
